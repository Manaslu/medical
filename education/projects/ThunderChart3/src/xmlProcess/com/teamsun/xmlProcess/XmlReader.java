package com.teamsun.xmlProcess;
...
//		String path = request.getRealPath("WEB-INF") + "/"+fileName;
		String path = "/WEB-INF/" + fileName;
		System.out.println("path:"+path);
		SAXReader reader = new SAXReader();
		try {
			InputStream is = this.getServletConfig().getServletContext().getResourceAsStream(path);
