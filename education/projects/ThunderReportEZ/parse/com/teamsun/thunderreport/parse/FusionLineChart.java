...
public class FusionLineChart {
	...
	public FusionLineChart(List elements, Map conds, String filename) {
		for (int i = 0; i < elements.size(); i++) {
			Element element = (Element) elements.get(i);
			String id = element.attributeValue("id");
			FusionLineChartEx chartEx = new FusionLineChartEx(element, conds,
					filename);
	...
	public FusionLineChartEx getFusionLineChartEx(String chartid) {
		return (FusionLineChartEx) this.finallycharts.get(chartid);
	}
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		FusionLineChart fusionLineChart = new FusionLineChart(l, m, "");
