...
/**
 * LabelValue.java * A simple JavaBean to represent label-value pairs. This is
 * most commonly used when constructing user interface elements which have a
 * label to be displayed to the user, and a corresponding value to be returned
 * to the server. One example is the <code>&lt;html:options&gt;</code> tag.
 * <p/> <p/> Note: this class has a natural ordering that is inconsistent with
 * equals.
 * </p>
 * 
