...
public class GroupContactTask extends CommonTaskGadget {

	/**
	 * 集团技术联系人
	 */
	private static final long serialVersionUID = -3060791606777849633L;
	//注入service的方法
	...
	public void goForWard(WfRunTimeContext context) throws WfBusinessException {
		...
		String groupLeader = (String)billVO.get("nextUserId");
		Demand demand = new Demand();
		demand.setId(id);
		demand.setApproState("c");
		demand.setGroupLeader(groupLeader);
		demandService.update(demand);
		System.out.println("把需求列表里面的状态改为--------->领导待审批");
		//在节点信息号里添加相应信息
