 ...
 */
@Controller
@RequestMapping("/postClean")
public class PostCleanController extends BaseController<TableInteRule, String> {
    private static final Log logger = LogFactory.getLog(PostCleanController.class);
    ...
    public Map<String, Object> execute(@RequestParam String params) {
        ...
        try {
            ...
            typeParams.put("ruleType", RuleType.POST_RULE.getType());
            ...
            tabRules.setRuleType(RuleType.POST_RULE.getType());
