...
//     app.controller('InnerServicePostMatchCtrl', [ '$scope', InnerServicePostMatchCtrl ]);
define(function(require, exports, module) {

    return function setApp(app) {
        app.controller('InnerServicePostMatchCtrl', [
                '$scope',
                'DataDefinition',
                'DataInteLog',
                'DataSet',
                ...
                'TableInteRule',
                'dialog',
                function($scope, DataDefinition, DataInteLog, DataSet, DataDefinitionAttr, PostClean, timeout,
                    ...
                    $scope.selectDs = function(item) {
                        ...
                        DataSet.post({
                            ...
                            $scope.data.resultDataSetName = item.dataSetName + "_邮编匹配" + (jsonData.count + 1);
                        });
                        // 字段列表
                    ...
                    $scope.dataStr = function() {
                        ...
                        str += currDate.getHours();
                        str += currDate.getMinutes();
                        return str;
                    }
...
//                            alert("程序后台执行中");
                            timeout(function() {
                                ...
                                dialog("邮编匹配后台执行中，请稍后点击“查询”查看数据匹配结果。" , '友情提示' );
                            }, 300);
...
//                        }, function() {
////                            alert("程序后台执行中");
//                            dialog("邮编匹配后台执行中，请稍后查询数据匹配结果。" , '友情提示' );
//                            $scope.toView(0);
//                        });
//                    };
